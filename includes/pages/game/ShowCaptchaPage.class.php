...
class ShowCaptchaPage extends AbstractGamePage
{
	...
	function send()
	{
		...
		header('Location: http://'.$_SERVER['HTTP_HOST'].'/beta/game.php?page=captcha');
		...
		header('Location: http://'.$_SERVER['HTTP_HOST'].'/jc/game.php?page=overview');	
		}else{
		...
		header('Location: http://'.$_SERVER['HTTP_HOST'].'/jc/game.php?page=captcha');	
		}
