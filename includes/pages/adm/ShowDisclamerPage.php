...
function ShowDisclamerPage()
{
	...
	$template->loadscript('scripts/base/jquery.autosize-min.js');
	...
	$template->assign_vars(array(
		...
		'se_disclaimerAddress'	=> $LNG['se_disclamerAddress'],
		'se_disclaimerPhone'	=> $LNG['se_disclamerPhone'],
		'se_disclaimerMail'		=> $LNG['se_disclamerMail'],
		'se_disclaimerNotice'	=> $LNG['se_disclamerNotice'],
	));
