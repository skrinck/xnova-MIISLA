...
function ShowFleetLogPage()
{
	...
	LEFT JOIN ".PLANETS." ptarget ON ptarget.id = fleet_end_id
	LEFT JOIN ".USERS." ustart ON ustart.id = fleet_owner
	LEFT JOIN ".USERS." utarget ON utarget.id = fleet_target_owner WHERE fleet_universe = ".Universe::getEmulated()." AND fleet_mission = 3 ORDER BY ".$orderBy." DESC LIMIT 10000;");
