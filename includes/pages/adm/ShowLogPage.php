...
function ShowLogCampaignList() {
	...
	$template->assign_vars(array(	
		...
		'pageTitle'		=> $LNG['log_campaign'],
		'pageactiveshow'=> "campaign",
	));
...
function ShowLogPresent() {
	...
	$template->assign_vars(array(	
		...
		'log_id'		=> $LNG['log_id'],
		'log_view'		=> $LNG['log_view'],
		'pageTitle'		=> $LNG['log_present'],
		'pageactiveshow'=> "Present_Logs",
		'pageactiveshow1'=> "present",
	));
	$template->show("LogList.tpl");
}