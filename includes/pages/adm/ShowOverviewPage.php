...
function ShowOverviewPage()
{
	...
	$cantUsers	 = "SELECT COUNT(id) AS total FROM ".USERS." ";
	$cantUsers		= $GLOBALS['DATABASE']->getFirstRow($cantUsers);
	...
	$template->loadscript('styles/assets/js/plugins/forms/selects/bootstrap_multiselect.js');
	$template->loadscript('styles/assets/js/core/app.js');
	$template->loadscript('styles/assets/js/pages/dashboard.js');
	...
	$template->assign_vars(array(	
		...
		'totalUsers'	=> pretty_number($cantUsers['total']),
