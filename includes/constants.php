...
if(!defined('CACHE_PATH')) {
	...
	//define('CACHE_PATH', '/srv/www/www.miisla.nat.cu/tmp/');
}
...
define('MODULE_ARSENAL'				, 43);
define('MODULE_ALLY_EXPULCION'		, 44);
define('MODULE_RDUCE_RESOURSE'		, 45);
define('MODULE_ALLY_TRANSPORT'		, 46);
define('MODULE_LOTTERY'			    , 47);
define('MODULE_TOURNEY'			    , 48);
define('MODULE_TOURNEY_WOA'		    , 49);
define('MODULE_SAVECOOR'		    , 50);
define('MODULE_BUILDING_BUY'		, 51);
define('MODULE_BONUS'				, 52);
define('MODULE_ASTEROID'			, 53);
define('MODULE_CAPTCHA'				, 54);
define('MODULE_PLANETRADAR'			, 55);
define('MODULE_RDUCE_FLEET'			, 56);
define('MODULE_GUBERNATORS'			, 57);
define('MODULE_MISSION_SAVE'		, 58);
define('MODULE_AMOUNT'				, 59);
