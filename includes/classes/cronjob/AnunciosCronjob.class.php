...
class AnunciosCronjob implements CronjobTask
{
	...
	{		
		...
		foreach($totalPremiums as $userInfo){
			...
			$Subject 	= '<span style="color:#666600">Anuncio</span>';
			$message = '<span style="color:#666600">'.$LNG['adsense_cron_'.mt_rand(1,14)].'</span>';
