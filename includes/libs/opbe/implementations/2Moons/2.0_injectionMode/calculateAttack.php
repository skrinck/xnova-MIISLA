...
require('includes/libs/opbe/implementations/2Moons/2.0_injectionMode/LangImplementation.php');
...
function getTechsFromArray($player)
{
    ...
    //$attTech = $player['military_tech'] + $gouvernor_attack + $player['factor']['Attack'] * 100;
    //$shieldTech = $player['shield_tech'] + $gouvernor_shield + $player['factor']['Shield'] * 100;
    //$defenceTech = $player['defence_tech'] + $gouvernor_shield  + $player['factor']['Defensive'] * 100; 
    $attTech = $player['military_tech'] + $gouvernor_attack + $player['rpg_amiral'];
    $shieldTech = $player['shield_tech'] + $gouvernor_shield + $player['rpg_amiral'];
    $defenceTech = $player['defence_tech'] + $gouvernor_shield + $player['rpg_amiral'];
    return array($attTech,$defenceTech,$shieldTech);
}
