...
$LNG['siteTitleNewsall']			= 'Todas las Noticias';
...
// Login
$LNG['loginadmin']					= 'Staff Conectado';
...
$LNG['registerWelcomePMText']		= '<h4>Bienvenido a %s!</h4><br> En primer lugar tienes que construir una planta de energía solar, ya que es el edificio que genera la energía que se necesita para la producción de materias primas. Para crear una, haga clic izquierdo en el menú de "<a href="game.php?page=buildings" style="font-size:12px;color:red">Estructuras</a>". Entonces construya el cuarto edificio contando apartir de la parte superior. </br> Cuando tengas construida la planta de energía, podrás comenzar a construir las minas. Ir a "<a href="game.php?page=buildings" style="font-size:12px;color:red">Estructuras</a>" en el menú y construir una Mina de Metal, seguido de una Mina de Cristal. </br></br>Con el fin de poder construir tus propias flotas, debes tener un "<a href="game.php?page=game.php?page=shipyard&mode=fleet" style="font-size:12px;color:red">Hangar</a>". Para ver lo que se necesita para desbloquear ese edificio se puede echar un vistazo al apartado "<a href="game.php?page=techtree" style="font-size:12px;color:red">Tecnologías</a>" en el menú superior un icono <i class="fas fa-flask fa-2x"></i>.</br>Si tienes más preguntas puedes mirar en la guía de <a href="game.php?page=questions" style="font-size:12px;color:red">Principiantes</a>, nuestro <a href="https://www.miisla.nat.cu/soporte" style="font-size:12px;color:red">xForo Soporte</a> o puedes buscar en el menú izquierdo <span class="fas fa-cogs" style="font-size:12px;color:red"> MODs</span> Tutorial o pinchar en el siguiente<a href="game.php?page=tutorial" style="font-size:12px;color:red">Enlace</a>.</br></br> El equipo te desea mucha diversión explorando el universo!';
...
//Impressum
$LNG['disclamerLabel']		        = 'Grupo de Trabajo:';
$LNG['disclamerLabelUser']          = 'Nombre de Usuario:';
$LNG['disclamerLabelRank']          = 'Cargo:';
