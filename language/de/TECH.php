...
$LNG['shortDescription'] = array(
	...
	45 => "The microscopic size of the nanorobots translates into higher operating speed. This factory produces nanorobots that are the latest evolution of robotic technology giving way to the Nanobots Factory. Once built, each update significantly decreases the time of investigations",
...
223 => 'It is an advanced version of the Battle Ship. Your destination, equipped with the latest technologies, is essential on all planets.',
224 => 'Ifrit defenses are the same, they have a faster and higher attack power than Shiva.',
225 => 'Shiva similar to the devil, the biggest difference is the cheapest cost of shiva.',
226 => 'Developed by races living off the attack after the Avatar arrived in the universe, this ship certainly made the universe the greatest defense weapon.',
227 => 'This ship, which claims to be the new nightmare of the universe, was developed by the Oxion clan, but thanks to the higher levels of espionage of the other races, each race can now produce it. It carries both high attack and defensive power at the same time',
228 => 'Odin, the fastest attack ship in the universe, is the eye of the pirates. You can travel very fast from one galaxy to another and capture the enemy at a time you never expected.',
230 => 'X-Wing, a ship that I appreciate mediated a black hole, from a completely unknown place. With a high technological level and weapons so powerful that they can bring down almost our Avatar.',
231 => 'Reaper, There are not many ships as destructive as those of the Reaper class: it combines combat power, powerful shields, speed and capacity with the unique ability to decompose part of the debris fields generated after a battle. This, however, will not be possible after the fight against alien or pirate ships.',
...
412 => "Photonic cannon, a highly destructive fleet weapon, was taken from the recent X-Wing found at the opening, from the unidentified black hole but thanks to that it gave way to a new defensive level. More effective in defending our planets from aggressive hostile ships.",
413 => 'Raptor Canyon, the technological difficulties revealed as a result of experiments with plasma generators led to the successful implementation of a new experimental program that opened the possibility of using the principle of two-chamber modules, which was carried out in future projects The successful tests of the The plant has become an important step towards the creation of more powerful PFC facilities with two-phase reactors. Raptor: it is the last of a series of mobile installations, foldable and transportable, and the first, between PKO media capable of hitting objects with two types of guns simultaneously.',
414 => 'Hammer Cannon Mortar, Hammer Cannon Ion Mortar DM-12 The hammer is a very effective means of SPF, which works optimally for low-flying targets. In the multilayer stepped defense system, it is indispensable as a means of the second division PKO. It is not bad to prove yourself in numerous local conflicts, especially effective against the Battleships, which constitute the backbone of many fleets, it also works well for cruise ships and destroyers.',
	...
	616 => "Dora is a girl who likes exploration a lot, she was in charge of developing a new method of production of the Intergalactic Dark Matter Collector. Which makes 1 MO Collector for half the price.",
	617 => "The Architect can build an entire city, with half of the resource previously used before his arrival.",
