{block name="title" prepend}{$LNG.all_frac_2}{/block}
{block name="content"}
<div id="content">
	<div id="ally_content" class="conteiner">
		<div class="gray_stripe">   	
    		{$LNG.all_frac_2}  
	        <span style="color:#FC6; float:right;" id="span_point">{$ally_fraction_credits} {$LNG.tech.923}</span>
		</div>
		<div class="ally_contents" style="color:#CCC; padding:0px;">
	    	 <img alt="" title="" style="float:left; height:64px; width:68px;" src="{$dpath}img/race/fraction_2.png" />
	         <p style="padding:6px;">
		...
		{/if}
		<div class="gray_stripe" style="position: static">
	        <a href="?page=alliance" >{$LNG.ally_fractions_6}</a>
	    </div>
