...
<div class="container container-page" style="width: 95%;">
	...
	<table class="table">
		<thead>
			...
			<tr>
				<td colspan="9">
					<h5 class="textBeefy text-center">{$LNG.tut_m4_name} - {$livello4} {$Si4}{$No4}</h5>
				</td>
			</tr>
			<tr>
				<td class="k">
			...
			<tr>
				<td colspan="9" class="text-center">
					<a href ="game.php?page=tutorial&mode=m5"><input type="submit" class="btn btn-sm btn-dark" value="{$LNG.tut_go_to} {$LNG.tut_m5}" onclick="window.location = 'game.php?page=tutorial&mode=m5'"/></a>
				</td>
			</tr>
			{/if}
		</thead>
