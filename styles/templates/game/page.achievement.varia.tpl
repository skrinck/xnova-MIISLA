            ...
            <div class="ach_menu">
                <ul>
                        ...
                        <a href="game.php?page=achievement&amp;group=daily">{$LNG.achiev_4} <sup class="text-danger">Funcional</sup></a>
                                        ...
                                        <li>
                        <a href="game.php?page=achievement&amp;group=build">{$LNG.achiev_5} <sup class="text-danger">Funcional</sup></a>
                    </li>
                                        <li>
...
<!--                    <div class="alert alert-info text-center">Estos logros se encuentras desactivados</div>-->
              ...
              <div id="ach_wons" class="ach_content">
                ...
                <div id="ach_destroyer_moons" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_varia_2_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<table class='tooltip_class_table'> <tbody><tr><th colspan='2'><span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}</span></th></tr><tr><td colspan='2' style='padding: 3px;'> {$achievement_varia_2_missing} </td></tr><tr><th colspan='2'><span style='color:#F90; font-weight:bold;'>{$LNG.achiev_12}</span></th></tr> <tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.tech.921}' src='styles/theme/gow/atm.gif' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.tech.921} </td> <td class='tooltip_class_table_text_left'>{$achievement_varia_2_next_am} </td> </tr><tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.achiev_13}' src='styles/theme/gow/stars.png' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.achiev_13} </td> <td class='tooltip_class_table_text_left'>{$achievement_varia_2_next_points} </td> </tr></tbody></table>">?</div>
                    <div class="ach_next_info_line" style="width:{$achievement_varia_2_percent}%;"></div>
                                        
                	<div class="ach_img">
                    	<img alt="Уничтожитель лун" src="styles/theme/gow/achiev/ach_destroyer_moons.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_creation_moons" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_varia_3_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<table class='tooltip_class_table'> <tbody><tr><th colspan='2'><span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}</span></th></tr><tr><td colspan='2' style='padding: 3px;'> {$achievement_varia_3_missing} </td></tr><tr><th colspan='2'><span style='color:#F90; font-weight:bold;'>{$LNG.achiev_12}</span></th></tr> <tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.tech.921}' src='styles/theme/gow/atm.gif' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.tech.921} </td> <td class='tooltip_class_table_text_left'>{$achievement_varia_3_next_am} </td> </tr><tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.achiev_13}' src='styles/theme/gow/stars.png' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.achiev_13} </td> <td class='tooltip_class_table_text_left'>{$achievement_varia_3_next_points} </td> </tr></tbody></table>">?</div>
                    <div class="ach_next_info_line" style="width:{$achievement_varia_3_percent}%;"></div>
                                        
                	<div class="ach_img">
                    	<img alt="Лунодел" src="styles/theme/gow/achiev/ach_creation_moons.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_wons_em" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_varia_4_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}:</span> <br>{$achievement_varia_4_missing}<br><br><span style='color:#F90; font-weight:bold;'>{$LNG.achiev_12}:</span> <br> • {$achievement_varia_4_next_am} {$LNG.tech.921} <br> • {$achievement_varia_4_next_points} {$LNG.achiev_13}">?</div>
                    <div class="ach_next_info_line" style="width:{$achievement_varia_4_percent}%;"></div>
                                        
                	<div class="ach_img">
                    	<img alt="Победы хостаил" src="styles/theme/gow/achiev/ach_wons_em.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_expedition" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_varia_5_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<table class='tooltip_class_table'> <tbody><tr><th colspan='2'><span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}</span></th></tr><tr><td colspan='2' style='padding: 3px;'> {$achievement_varia_5_missing} </td></tr><tr><th colspan='2'><span style='color:#F90; font-weight:bold;'>{$LNG.achiev_12}</span></th></tr> <tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.tech.921}' src='styles/theme/gow/atm.gif' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.tech.921} </td> <td class='tooltip_class_table_text_left'>{$achievement_varia_5_next_am} </td> </tr><tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.achiev_13}' src='styles/theme/gow/stars.png' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.achiev_13} </td> <td class='tooltip_class_table_text_left'>{$achievement_varia_5_next_points} </td> </tr></tbody></table>">?</div>
                    <div class="ach_next_info_line" style="width:{$achievement_varia_5_percent}%;"></div>
                                        
                	<div class="ach_img">
                    	<img alt="Удачная экспедиция" src="styles/theme/gow/achiev/ach_expedition.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_found_tm" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_varia_6_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<table class='tooltip_class_table'> <tbody><tr><th colspan='2'><span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}</span></th></tr><tr><td colspan='2' style='padding: 3px;'> {$achievement_varia_6_missing} </td></tr><tr><th colspan='2'><span style='color:#F90; font-weight:bold;'>{$LNG.achiev_12}</span></th></tr> <tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.tech.921}' src='styles/theme/gow/atm.gif' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.tech.921} </td> <td class='tooltip_class_table_text_left'>{$achievement_varia_6_next_am} </td> </tr><tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.achiev_13}' src='styles/theme/gow/stars.png' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.achiev_13} </td> <td class='tooltip_class_table_text_left'>{$achievement_varia_6_next_points} </td> </tr></tbody></table>">?</div>
                    <div class="ach_next_info_line" style="width:{$achievement_varia_6_percent}%;"></div>
                                        
                	<div class="ach_img">
                    	<img alt="Искатель материи" src="styles/theme/gow/achiev/ach_found_tm.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_found_up" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_varia_7_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}:</span> <br>{$achievement_varia_7_missing}<br><br><span style='color:#F90; font-weight:bold;'>{$LNG.achiev_12}:</span> <br> • {$achievement_varia_7_next_am} {$LNG.tech.921} <br> • {$achievement_varia_7_next_points} {$LNG.achiev_13}">?</div>
                    <div class="ach_next_info_line" style="width:{$achievement_varia_7_percent}%;"></div>
                                        
                	<div class="ach_img">
                    	<img alt="Искатель апгрейдов" src="styles/theme/gow/achiev/ach_found_up.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_action_up" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_varia_8_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}:</span> <br>{$achievement_varia_8_missing}<br><br><span style='color:#F90; font-weight:bold;'>{$LNG.achiev_12}:</span> <br> • {$achievement_varia_8_next_am} {$LNG.tech.921} <br> • {$achievement_varia_8_next_points} {$LNG.achiev_13}">?</div>
                    <div class="ach_next_info_line" style="width:{$achievement_varia_8_percent}%;"></div>
                                        
                	<div class="ach_img">
                    	<img alt="Интегратор апгрейдов" src="styles/theme/gow/achiev/ach_action_up.png">
                    </div>
                    <div class="ach_content_text">
