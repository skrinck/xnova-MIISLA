...
<div id="content">
	<div id="ally_content" class="conteiner">
		<div class="gray_stripe" style="padding-right:0; margin-bottom:5px;">
	    	{$LNG.al_manage_diplo}
	        <a href="game.php?page=alliance&amp;mode=admin&amp;action=diplomacyCreate&amp;diploMode=0" class="right_flank btn btn-dark btn-xs" onclick="return Dialog.open(this.href, 684, 283);" style="padding:6px;">
	    ...
	    {foreach $diploList.0 as $diploMode => $diploAlliances}	
			...
			<div class="ally_contents">
				{foreach $diploAlliances as $diploID => $diploName}
					...
					<img src="styles/resource/images/false.png" alt="" height="14" width="14"></a>
				{foreachelse}
								...
								{$LNG.al_diplo_level.$diploMode}<br>
									...
									{foreach $diploAlliances as $diploID => $diploName}   
										<li>
											...
											<img src="styles/resource/images/true.png" alt="" height="16" width="16"></a>
											...
											<img src="styles/resource/images/false.png" alt="" height="16" width="16"></a>
										</li>
									{/foreach}
									</ul>
							{/if}
