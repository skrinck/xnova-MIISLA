	...
	<div id="ally_content" class="conteiner">
		<div class="gray_stripe" style="margin-bottom:5px;">
	        ...
	        (<a href="game.php?page=alliance&amp;mode=logStorageFull">{$LNG.al_storage_logs_all}</a> | 
	         <a href="game.php?page=alliance&amp;mode=logstorage&amp;time=1">{$LNG.al_storage_logs_mes}</a> | 
	         <a href="game.php?page=alliance&amp;mode=logstorage&amp;time=2">{$LNG.al_storage_logs_sem}</a> | 
	         <a href="game.php?page=alliance&amp;mode=logstorage&amp;time=3">{$LNG.al_storage_logs_dia}</a>)
