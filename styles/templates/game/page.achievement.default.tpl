		...
		<div class="ach_main_content">
            ...
            <div class="ach_content_box">
            	<div style="float:left; width:100%;">
                    <div class="alert alert-info text-center">Estos logros se encuentran desactivados.</div>
                               
                <!--<div id="ach_level" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_common_1_current_points}</div>
                ...
                <tr>
					...
					<img alt='{$LNG.tech.922}' src='styles/theme/gow/atm.gif' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.tech.922}                           
                    </td>
				...
				<tr>
                	<td style='text-align: right;line-height: 19px;'>
					<img alt='{$LNG.achiev_13}' src='styles/theme/gow/stars.png' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.achiev_13}                           
                    </td>
                	<td class='tooltip_class_table_text_left'>
                	...
                	<div class="ach_img">
                    	<img alt="{$LNG.achiev_14}" src="styles/theme/gow/achiev/ach_level.png">
                    </div>
                ...
                <div id="ach_batle_level" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_common_2_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<table class='tooltip_class_table' style='max-width: 200px;'>
            	<tbody><tr><th colspan='2'><span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}</span></th></tr>
				<tr><td colspan='2' style='padding: 3px;'>
				...
				<tr>
                	...
                	<div class="ach_img">
                    	<img alt="{$LNG.achiev_21}" src="styles/theme/gow/achiev/ach_batle_level.png">
                    </div>
                    <div class="ach_content_text">
