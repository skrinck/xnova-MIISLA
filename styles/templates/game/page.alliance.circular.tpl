		...
		<form name="message" id="message">
			<table style="width:100%;">
				...
				<tr>
					...
					<input type="reset" class="btn btn-dark btn-xs" value="{$LNG.al_circular_reset}">
					<input type="button" class="btn btn-dark btn-xs" onClick="return check();" name="button" value="{$LNG.al_circular_send_submit}">
					</th>
				</tr>
			</table>
		</form>
