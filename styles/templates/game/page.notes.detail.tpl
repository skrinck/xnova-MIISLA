	...
	<div>
		<form action="?page=notes&amp;mode=insert" method="post">
			...
			<table style="width:100%;">
				...
				<tr>
					<td><a class="btn btn-dark btn-xs" href="game.php?page=notes">{$LNG.nt_back}</a></td>
					<td>
						<input class="btn btn-dark btn-xs" type="reset" value="{$LNG.nt_reset}">
						<input class="btn btn-dark btn-xs" type="submit" value="{$LNG.nt_save}">
					</td>
				</tr>
			</table>
		</form>
