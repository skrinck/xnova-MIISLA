...
<div class="container container-page" style="width: 95%;">
	...
	<table class="table">
		<thead>
			...
			<tr>
				<td colspan="9">
					<h5 class="textBeefy text-center">{$LNG.tut_m8_name} - {$livello8} {$Si8}{$No8}</h5>
				</td>
			</tr>
			<tr>
				<td class="k">
					<p id="aufgabentext"><img src="{$dpath}gebaeude/208.gif" class="pic"></p>
			...
			<tr>
				<td colspan="9" class="text-center">
					<a href ="game.php?page=tutorial&mode=m9"><input type="submit" class="btn btn-sm btn-dark" value="{$LNG.tut_go_to} {$LNG.tut_m9}" onclick="window.location = 'game.php?page=tutorial&mode=m9'"/></a>
				</td>
			</tr>
			{/if}
		</thead>
