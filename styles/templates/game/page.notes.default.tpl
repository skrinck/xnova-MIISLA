...
<div class="content_page" style="width: 95%;">
	...
	<div>
		...
		<table style="width:100%;">
			<tr>
				<td colspan="4"><a class="btn btn-dark btn-xs" href="game.php?page=notes&amp;mode=detail">{$LNG.nt_create_new_note}</a></td>
			</tr>
			<tr>
			...
			{if $notesRow@last}
			<tr>
				<td colspan="4" class="right"><input class="btn btn-dark btn-xs" value="{$LNG.nt_dlte_note}" type="submit"></td>
			</tr>
			{/if}
			{foreachelse}
			<tr>
