	...
	<div id="ally_content" class="conteiner">
	    ...
	    {foreach $Userlist as $ID => $Alliance}      
			<div class="ally_img">
				...
				{if $Alliance.ally_fraction_id != 0}<img alt="" title="" class="tooltip fraction_ico_mini_t" data-tooltip-content="{$Alliance.ally_fraction_name} ({$Alliance.ally_fraction_level})" src="{$dpath}img/race/fraction_{$Alliance.ally_fraction_id}.png">{/if}
