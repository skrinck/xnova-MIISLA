...
<div id="content">
	<div id="ally_content" class="conteiner">
		<div class="gray_stripe">
	        ...
	        <a href="game.php?page=alliance" class="batn_lincks right_flank">{$LNG.all_over}</a>                       
	    </div>
	    <div class="ally_img">
		...
		<form action="game.php?page=alliance&amp;mode=admin" method="post">
			...
			<div class="ally_contents">
				...
				<div class="left_part">
					<input class="right_flank" value="{$LNG.al_circular_reset}" type="reset" style="line-height:27px; width:100px; margin:0 auto; margin-top:10px;"> 
				</div>
				<div class="right_part">
					<input value="{$LNG.al_save}" type="submit" style="line-height:27px; width:100px; margin:0 auto; margin-top:10px;">
				</div>
				<div class="clear"></div>
			</div>
			...
			<div class="ally_contents">
				...
				<div class="clear"></div> 
				<label class="left_label">{$LNG.al_manage_image} (714px x 215px)</label>
				...
				<select name="events[]" size="{$available_events|@count}" multiple style="height: 100px">
			...
			<input class="big_seting_text" min="1" max="{$ally_max_members}" name="ally_max_members" value="{$ally_max_members}" size="8" type="number">
			<div class="clear"></div> 
