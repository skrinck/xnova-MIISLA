		...
		<div class="ach_main_content">
            ...
            <div class="ach_content_box">
                ...
                <div id="ach_spy_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_1_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Шпион" src="styles/theme/gow/achiev/ach_spy_tech.png">
                    </div>
                ...
                <div id="ach_computer_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_2_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Хакер" src="styles/theme/gow/achiev/ach_computer_tech.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_war_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_3_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Непобедимые технологи" src="styles/theme/gow/achiev/ach_war_tech.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_expedition_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_4_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Экспедиционер" src="styles/theme/gow/achiev/ach_expedition_tech.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_gravity_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_5_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Гравитация" src="styles/theme/gow/achiev/ach_gravity_tech.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_gun_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_6_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Сила орудий" src="styles/theme/gow/achiev/ach_gun_tech.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_energy_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_7_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Энергетик" src="styles/theme/gow/achiev/ach_energy_tech.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_motor_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_9_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Повышение скорости" src="styles/theme/gow/achiev/ach_motor_tech.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_mining_tech" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_tech_10_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Геолог" src="styles/theme/gow/achiev/ach_mining_tech.png">
                    </div>
                    <div class="ach_content_text">
