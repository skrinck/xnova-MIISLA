...
<div class="container container-page" style="width: 95%;">
	...
	<table class="table">
		<thead>
			...
			<tr>
				<td colspan="9">
					<h5 class="textBeefy text-center">{$LNG.tut_m6_name} - {$livello6} {$Si6}{$No6}</h5>
				</td>
			</tr>
			<tr>
				<td class="k">
			...
			<tr>
				<td colspan="9" class="text-center">
					<a href ="game.php?page=tutorial&mode=m7"><input type="submit" class="btn btn-sm btn-dark" value="{$LNG.tut_go_to} {$LNG.tut_m7}" onclick="window.location = 'game.php?page=tutorial&mode=m7'"/></a>
				</td>
			</tr>
			{/if}
		</thead>
