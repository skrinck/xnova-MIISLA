            ...
            <div class="ach_content_box">
               ...
               <!-- <div id="ach_wons_day" class="ach_content">
                ...
                <div id="ach_expedition_day" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_daily_2_current_points}</div>
                                        <div class="ach_next_info tooltip" data-tooltip-content="<table class='tooltip_class_table' style='max-width: 200px;'> <tbody><tr><th colspan='2'><span style='color:#3CF; font-weight:bold;'>{$LNG.achiev_10}</span></th></tr><tr><td colspan='2' style='padding: 3px;'> {$achievement_daily_2_missing} </td></tr><tr><th colspan='2'><span style='color:#F90; font-weight:bold;'>{$LNG.achiev_12}</span></th></tr> <tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.tech.921}' src='styles/theme/gow/images/921.png' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.tech.921} </td> <td class='tooltip_class_table_text_left'>{$achievement_daily_2_next_am} </td> </tr><tr> <td style='text-align: right;line-height: 19px;'><img alt='{$LNG.achiev_13}' src='styles/theme/gow/stars.png' style='height: 14px;width: 14px;float: left;padding: 3px;'>{$LNG.achiev_13} </td> <td class='tooltip_class_table_text_left'>{$achievement_daily_2_next_points} </td> </tr></tbody></table>">?</div>
                    <div class="ach_next_info_line" style="width:{$achievement_daily_2_percent}%;"></div>
                                        
                	<div class="ach_img">
                    	<img alt="Удачная экспедиция / сутки" src="styles/theme/gow/achiev/ach_expedition_day.png">
                    </div>
                    <div class="ach_content_text">
              ...
              <!--  <div id="ach_wons_em_1_day" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_daily_3_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Победы хостаил - Варвары / сутки" src="styles/theme/gow/achiev/ach_wons_em_1_day.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_wons_em_2_day" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> {$achievement_daily_4_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Победы хостаил - Пираты / сутки" src="styles/theme/gow/achiev/ach_wons_em_2_day.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_wons_em_3_day" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> <i class="fas fa-star"></i> {$achievement_daily_5_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Победы хостаил - Чужие / сутки" src="styles/theme/gow/achiev/ach_wons_em_3_day.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <div id="ach_wons_em_4_day" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> <i class="fas fa-star"></i> {$achievement_daily_6_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Победы хостаил - Руины / сутки" src="styles/theme/gow/achiev/ach_wons_em_4_day.png">
                    </div>
                    <div class="ach_content_text">
               ...
               <div id="ach_wons_em_5_day" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> <i class="fas fa-star"></i> {$achievement_daily_7_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Победы хостаил - Шахтеры / сутки" src="styles/theme/gow/achiev/ach_wons_em_5_day.png">
                    </div>
                    <div class="ach_content_text">
                ...
                <!--<div id="ach_wons_em_6_day" class="ach_content">
                	<div class="stars_2"><i class="fas fa-star"></i> <i class="fas fa-star"></i> {$achievement_daily_8_current_points}</div>
                	...
                	<div class="ach_img">
                    	<img alt="Победы хостаил - Дроиды / сутки" src="styles/theme/gow/achiev/ach_wons_em_6_day.png">
                    </div>
                    <div class="ach_content_text">
