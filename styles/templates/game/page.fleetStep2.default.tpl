    ...
    <div>
        ...
        <input type="hidden" name="token" value="{$token}">
            <table style="width: 100;">
                                    ...
                                    {if $MissionID == 15}
                                        <br>
                                            <div class="alert alert-danger text-center">
                                                <i class="fas fa-exclamation-triangle fa-5x pull-left"></i> 
                                                {$LNG.fl_expedition_alert_message}
                                            </div>
                                            <tr style="height:20px;">
                                                <td class="transparent">
                                                    <img src="styles/images/captcha/{$captcha}.png">
                                                    <input name="captcha" size="10" type="text">
                                                    <input name="captcha_code" type="text" style="display: none;" value="{$captcha}">
                                                </td>
                                            </tr>
                                        <br>
                                    {/if}
                ...
                {/if}
                <tr style="height:20px;">
                    <td colspan="2" align="center"><input class="btn btn-dark btn-xs" value="{$LNG.fl_continue}" type="submit" /></td>
                </tr>
            </table>
        </form>
    </div>
