...
<head>
	...
	<script type="text/javascript" src="styles/assets/js/plugins/ui/moment/moment.min.js"></script>
	<script type="text/javascript" src="styles/assets/js/plugins/pickers/daterangepicker.js"></script>
	<!-- /core JS files -->
	<!-- Theme JS files -->
	...
	function setLanguage(LNG, Query) {
		$.cookie('lang', LNG);
