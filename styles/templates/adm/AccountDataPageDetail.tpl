				...
				<div class="page-header">
					...
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">{$LNG['mu_info_account_page']}</span> - {$LNG['profile']}</h4>

							<ul class="breadcrumb position-right">
								<li><a href="admin.php">{$LNG['home']}</a></li>
								<li><a href="admin.php?page=accountdata">{$LNG['mu_info_account_page']}</a></li>
								<li class="active">{$LNG['profile']}</li>
							</ul>
						</div>
					...
					<div class="navbar navbar-default navbar-xs">
						...
						<div class="navbar-collapse collapse" id="navbar-filter">
							<ul class="nav navbar-nav element-active-slate-400">
								<li class="active"><a href="#profil" data-toggle="tab"><i class="icon-menu7 position-left"></i> {$LNG['mu_info_account_page']}</a></li>
								<li><a href="#logs" data-toggle="tab"><i class="icon-calendar3 position-left"></i> {$LNG['player_log']}</a></li>
								<li><a href="#antimatter" data-toggle="tab"><i class="icon-calendar3 position-left"></i> {$LNG['antimater_log']}</a></li>
								<li><a href="#pagesvisits" data-toggle="tab"><i class="icon-file-eye position-left"></i> {$LNG['visit_pages']}</a></li>
								<li><a href="#notes" data-toggle="tab"><i class="icon-stack-text position-left"></i> {$LNG['modul'][17]}</a></li>
								<li><a href="#friends" data-toggle="tab"><i class="icon-collaboration position-left"></i> {$LNG['bu_partners']}</a></li>
							</ul>
							...
							<div class="tabbable">
								<div class="tab-content">
									...
									<div class="tab-pane fade" id="notes">
										...
										<div class="panel panel-flat">
											<div class="panel-heading">
												<h6 class="panel-title">{$value['title']}</h6>
												<div class="heading-elements">
													<ul class="icons-list">
														<li style="color:#ccc">{$LNG.ago} {$value['timem']}</li>
														<li><a data-action="collapse"></a></li>
													</ul>
												</div>
											</div>
										...
										<div class="panel panel-flat">
											<div class="panel-heading">
												<h6 class="panel-title text-primary">
													<i class="fa fa-user"></i> {$value['username']} -[{$value['galaxy']}:{$value['system']}:{$value['planet']}]
												</h6>
											</div>
										</div>
										{/foreach}
