										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li><a href="?page=usersonline&amp;delete=user&amp;user={$userID}" onclick="return confirm('{$LNG.ul_sure_you_want_dlte} - {$onlineRow.username}');"><i class="glyphicon glyphicon-remove"></i> {$LNG['up_del']}</a></li>
												</ul>
											</li>
										</ul>
									</td>
