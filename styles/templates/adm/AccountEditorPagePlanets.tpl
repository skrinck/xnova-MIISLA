...
<table width="100%">
<tr>
<td colspan="3" align="left"><a class="btn btn-default btn-xs" href="?page=accounteditor">
<img src="./styles/resource/images/admin/arrowright.png" width="16" height="10"> {$LNG.ad_back_to_menu}</a></td>
	...
	<td><span class="tooltip" style="opacity:1" title="{$LNG.ad_pla_title_l}">{$LNG.ad_pla_change_p}</span></td>
