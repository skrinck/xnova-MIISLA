				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">{$LNG['ingame_setting']}</span> - {$LNG['se_galaxy_settings']}</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="admin.php?page=galaxyset">{$LNG['ingame_setting']}</a></li>
							<li class="active">{$LNG['se_galaxy_settings']}</li>
						</ul>
										...
										<fieldset>
											...
											<div class="collapse in" id="Frame8">
												<div class="form-group">
													<label class="col-lg-3 control-label">{$LNG['se_max_galaxy']} <i class="fa fa-info-circle text-danger tooltip" title="{$LNG['se_max_galaxy_info']}"></i></label>
													<div class="col-lg-9">
														<input type="text" name="max_galaxy" value="{$max_galaxy}" class="form-control">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-3 control-label">{$LNG['se_max_system']} <i class="fa fa-info-circle text-danger tooltip" title="{$LNG['se_max_system_info']}"></i></label>
													<div class="col-lg-9">
														<input type="text" name="max_system" value="{$max_system}" class="form-control">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-3 control-label">{$LNG['se_max_planets']} <i class="fa fa-info-circle text-danger tooltip" title="{$LNG['se_max_planets_info']}"></i></label>
													<div class="col-lg-9">
