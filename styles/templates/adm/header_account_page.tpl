				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">{$LNG['mu_users_settings']}</span> - {$LNG['ad_editor_title']}</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="admin.php?page=accounteditor">{$LNG['ad_editor_title']}</a></li>
							<li class="active">{$LNG['ad_editor_title']}</li>
						</ul>
